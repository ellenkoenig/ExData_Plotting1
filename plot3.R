...
sub_metering = data.frame(1:2880)
sub_metering['sub_metering_1'] <- ts(relevant_data$Sub_metering_1, frequency = 1440)
sub_metering['sub_metering_2'] <- ts(relevant_data$Sub_metering_2, frequency = 1440)
sub_metering['sub_metering_3'] <- ts(relevant_data$Sub_metering_3, frequency = 1440)
